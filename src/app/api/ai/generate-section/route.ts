...
export async function POST(request: Request) {
  ...
  try {
    ...
    messagesContent.push({ type: "text", text: `Generate content for section ID "${sectionId}" and any other relevant sections using the provided unstructured notes and report context.` });
