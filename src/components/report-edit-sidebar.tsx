...
export function ReportEditSidebar({ sections, currentSectionId, onSectionChange }: ReportEditSidebarProps) {
            ...
            <SidebarMenu>
              {sortedSections.map((section) => (
                <SidebarMenuItem key={section.id}>
                  ...
                  <SidebarMenuBadge>{section.cards.length}</SidebarMenuBadge>
                </SidebarMenuItem>
              ))}
            </SidebarMenu>
          </SidebarGroupContent>
